    ...
    <div class="col-xl-12 col-lg-12">
        ...
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">انواع خانه های سازمانی</h4>
            </div>
                    ...
                    <div id=" example3_wrapper"  class=" dataTables_wrapper no-footer">
                        <div >
                            <form action="{{route('search.home_kinds')}}" method="get">
                                <a  class="btn btn-rounded btn-outline-info"  style=" margin-top: 4em;margin-right: 2em  " href="{{route('home_kinds.create')}}" >
                    ...
                    <table id="example3" class="display table-responsive-lg  table-bordered table-striped  dataTable no-footer" role="grid" aria-describedby="example3_info">
                        ...
                        @foreach($home_kinds as $home_kind)
                            ...
                            <tr>
                                ...
                                <td class="text-center align-middle">{{Hekmatinasser\Verta\Verta::instance( $home_kind->created_at)->format('%B %d، %Y')}}</td>
                                <td class="text-center align-middle">{{Hekmatinasser\Verta\Verta::instance( $home_kind->updated_at)->format('%B %d، %Y')}}</td>
