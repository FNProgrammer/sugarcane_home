                ...
                <div class="table-responsive">
                    <div id=" example3_wrapper"  class=" dataTables_wrapper no-footer">
                     ...
                     <form action="{{route('search.positions')}}" method="get">
                         <a  class="btn btn-rounded btn-outline-info"  style=" margin-top: 4em;margin-right: 2em  " href="{{route('positions.create')}}" >
                             <i class="fa fa-plus"></i>
                             <i  style="font-family:iransans-normal"> ایجاد سمت جدید</i>
                         </a>
                    ...
                    <table id="example3" class="display table-responsive-lg  table-bordered table-striped  dataTable no-footer" role="grid" aria-describedby="example3_info">
                        ...
                        @foreach($positions as $position)
                            ...
                            <tr>
                                ...
                                <td class="text-center align-middle">{{Hekmatinasser\Verta\Verta::instance( $position->created_at)->format('%B %d، %Y')}}</td>
                                <td class="text-center align-middle">{{Hekmatinasser\Verta\Verta::instance( $position->updated_at)->format('%B %d، %Y')}}</td>
